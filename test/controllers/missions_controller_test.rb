...
class MissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post missions_url, params: { mission: { drone_id: @mission.drone_id, location: @mission.location, name: @mission.name, weight: @mission.weight } }
    end
  ...
  test "should update mission" do
    patch mission_url(@mission), params: { mission: { drone_id: @mission.drone_id, location: @mission.location, name: @mission.name, weight: @mission.weight } }
